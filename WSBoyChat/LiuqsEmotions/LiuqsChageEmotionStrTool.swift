...
//        let attstrDic = [NSForegroundColorAttributeName:_textColor,NSFontAttributeName:_font,NSParagraphStyleAttributeName:paragraphStyle] as [String : Any]
        let attstrDic: [NSAttributedString.Key: Any] = [NSAttributedString.Key.foregroundColor: _textColor, NSAttributedString.Key.font: _font, NSAttributedString.Key.paragraphStyle: paragraphStyle]
